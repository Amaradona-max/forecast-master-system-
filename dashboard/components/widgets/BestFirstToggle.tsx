...
export function BestFirstToggle({
  value,
  onChange,
  className
}: {
  ...
  return (
    <button
      ...
      aria-pressed={value}
      title="Metti in cima i match migliori (BEST → TOP → resto)"
    >
      <span className="rounded-full bg-white/10 px-2 py-0.5 text-[10px] font-bold">⇧</span>
